  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 md:p-8 relative overflow-hidden bg-gradient-to-b from-sky-300 via-sky-50 to-white">
      ...
      <div className="w-full max-w-md relative z-10 bg-white/80 backdrop-blur-xl p-8 md:p-10 rounded-3xl border-2 border-sky-500/30 shadow-2xl shadow-slate-100/40 transition-all hover:shadow-slate-200/50">
        ...
        <h1 className="text-3xl font-extrabold text-slate-900 mb-2 tracking-tight">Tạo tài khoản mới</h1>
        <p className="text-slate-500 mb-8 text-sm">Đăng ký để bắt đầu hành trình du lịch của bạn</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex items-start gap-2 group/checkbox cursor-pointer">
            <input type="checkbox" required className="w-4 h-4 mt-1 rounded border-slate-300 text-sky-500 focus:ring-sky-500/20 focus:ring-2 accent-sky-500 cursor-pointer" />
            <span className="text-sm text-slate-500 group-hover/checkbox:text-slate-700 transition-colors">
              Tôi đồng ý với{' '}
              <Link href="/terms" className="text-sky-500 font-semibold hover:text-sky-600 transition-colors">Điều khoản sử dụng</Link>
              {' '}và{' '}
              <Link href="/privacy" className="text-sky-500 font-semibold hover:text-sky-600 transition-colors">Chính sách bảo mật</Link>
            </span>
          </div>
        ...
        <div className="mt-6">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white/70 backdrop-blur-md text-slate-400">Hoặc đăng ký với</span>
            </div>
          </div>
